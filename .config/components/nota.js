...
module.exports = function(options, context) {
    const title = options.title || options.titulo || 'Nota';
    ...
    return `
        <style>
            .${id}-box {
                ...
                position: relative;
                overflow: hidden;
                box-shadow: 0 4px 10px -1px rgba(55, 65, 81, 0.05), 0 2px 4px -1px rgba(55, 65, 81, 0.02);
            ...
            .${id}-box:hover {
                ...
                box-shadow: 0 12px 20px -3px rgba(55, 65, 81, 0.1), 0 4px 6px -2px rgba(55, 65, 81, 0.05);
            }
            .${id}-layout {
                display: flex;
                    ...
                    <svg viewBox="0 0 24 24" width="48" height="48" fill="none">
                        <defs>
                            ...
                            <mask id="${id}-mask">
                                ...
                                <text x="11" y="16.5" font-size="11" font-family="'Atkinson-Hyperlegible', 'Montserrat', sans-serif" font-weight="900" fill="black" text-anchor="middle">N</text>
                            </mask>
                        </defs>
                        ...
                        <path d="M14 2v6h6z" fill="#ffffff" opacity="0.35" />
                    </svg>
                </div>
                <div class="${id}-body">
